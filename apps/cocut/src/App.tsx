...
const assistantScriptUrl = import.meta.env.VITE_CHATBOT_SCRIPT_URL || (
  import.meta.env.DEV ? 'http://127.0.0.1:4100/chat-widget.js' : 'https://contentco-op.com/chat-widget.js'
);

const assistantApiUrl = import.meta.env.VITE_CHATBOT_API_URL || (
  import.meta.env.DEV ? 'http://127.0.0.1:4100/api/chat' : 'https://contentco-op.com/api/chat'
);
    ...
    return (
      <>
        ...
        <SiteAssistantLoader
          ...
          domain="cut.contentco-op.com"
          scriptUrl={assistantScriptUrl}
          surface="co-cut-login"
        />
      </>
    );
  }
