...
const htmlChecks = [
  ...
  },
  {
    ...
    required: [
      ...
      "Red Zone Safety",
      "U.S. Impact Report Motion Piece",
  ...
  },
  {
    ...
    required: [
      ...
      "2:40.74 1920x1080 safety episode",
      "23.976fps H.264/AAC delivery",
      "conduct hazard identification",
      "joint site inspection",
      "Maintain Communication rule card",
      "Pause for Risk Reassessment rule card",
      "implement safety controls",
      "Permit-to-work and sign-in context",
      "Refinery-unit interview coverage",
      "Warning signage and unit walkdowns",
      "Line of Fire terminology correction",
      "Final LCR delivery review",
    ],
    forbidden: [
  ...
  },
  {
    ...
    required: [
      ...
      "3:23.18 1080p TAR performance film",
      "23.976fps H.264/AAC delivery",
      ...
      "What do you want from today prompt",
      "Achieve early complete stable scope note",
      "TAR resource successful planning session prompt",
  ...
  },
  {
    ...
    required: [
      ...
      "4:23.66 1920x1080 safety film",
      "23.976fps H.264/AAC delivery",
      "Dropped-object exposure framing",
      "Remote expert interview sources",
      "Salunda CrewHawk digital Red Zone monitoring",
      "Helix Well Enhancer Light Well Intervention Vessel",
      "Helin Red Zone Manager detection view",
      "Warning Zone and Red Zone plan overlays",
      "Rig floor is never a safe place caption",
      "Device warning-zone alerts",
      "Deck audio cue examples",
      "Labeled equipment practices",
    ],
    forbidden: [
      "Drops-prevention training that survives review-room scrutiny",
      "Review-room clarity",
      "Wipster-approved cut",
  ...
  },
  {
    ...
    required: [
      ...
      "Potential new members, Baylor Kappas, national KKG audiences",
      "Rush-room playback, YouTube, social resurgence, convention archive",
    ],
    forbidden: ["Kappa Alpha Psi", "Campus-culture resonance", "Candidates, hiring teams, internal brand leaders"],
  },
  {
    ...
    required: [
      ...
      "3:05 1080p captioned year-end message",
      "bp Investing in America backdrop",
      "Argos Southwest Expansion first-oil chapter",
      "Gulf of America team thank-you",
      "Midstream asset sale and LS Power references",
      "Major turnarounds and plant-by-plant delivery",
      "JERA Nex bp offshore-wind chapter",
      "Chicago gas/power trading office context",
      "TravelCenters journey framing",
      "Wipster v5, v7, final, and final x3 review path",
      "Sentence-case captions and acronym checks",
      "Business-advisor final comments",
    ],
    forbidden: [
      "Executive messaging produced with the polish a year-end moment deserves.",
      "A leadership communication asset for global distribution and internal pride.",
      "Westlake and field b-roll",
      "Wipster review cycle",
      "Final x3 export",
      "polished internal leadership platform",
    ],
  },
  {
  ...
  },
  {
    ...
    required: [
      "bp America",
      "U.S. Impact Report Motion Piece",
      "We are BP brand opener",
      "$135 billion economic impact card",
      "190,000 American jobs card",
      "17,000 BP employees card",
      "$150 million community-programs card",
      "Offshore platform and refinery-at-sunset footage",
      "Wind-turbine energy-transition visuals",
      "Worker and control-room mosaics",
      "Sports and youth community montage",
      "Committed to America map finish",
      "30-second 1080p impact-report film",
    ],
    forbidden: [
      "ICA Economic Impact Film",
      "ICA aerial refinery",
      "Aerial refinery footage cut into a short industrial proof piece",
      "National footprint proof, refinery and wind visuals",
      "short, polished asset",
      "Social-ready proof asset",
    ],
  },
  {
    ...
    required: [
      ...
      "2:03.67 1920x1080 conference leadership film",
      "23.976fps H.264/AAC delivery",
      "Conexon Presents Co-ops Connect title card",
      "Tommy Thurmond, Habersham EMC leadership lower-third",
      "Michael Kirkland, Petit Jean Electric Cooperative CEO",
      "Jarrod Campbell, Osage Valley Electric Cooperative CEO",
      "Darren Farnan, United Electric Cooperative COO",
      "Ben Thomason, Central Georgia EMC COO",
      "Randy Carroll, East Mississippi Electric Power Association CEO",
      "Fiber Broadband Workshop title card",
      "Panel-room and round-table coverage",
      "Smart Grid round-table signage",
      "Registration badge closeups",
      "TPC Sawgrass golf context",
      "Conexon.us/events end card",
    ],
    forbidden: ["ICA Leadership Interview", "ICA CEO interview", "Executive messaging shaped with clarity and confidence.", "Gary Wood of Central Virginia Electric Cooperative", "Michael Kirkland of Pearl River Valley Electric", "2:04 1080p conference leadership film", "Sawgrass golf and venue context"],
  },
  {
    ...
    required: [
      ...
      "51.01-second 1280x720 event asset",
      "25fps H.264/AAC delivery",
      "Electric cooperative broadband workshop context",
      "2023 public agenda context",
      "Fiber-light opener",
      "Share and Connect text cards",
      "Round Tables and Face to Face messaging",
      "Heart to Heart interaction card",
      "Every Voice and Every Thought cards",
      "Pull Up a Chair card",
      "Engage and Lean In cards",
      "We're not just talking fiber card",
      "We're living it card",
      "Art of Sales and Precision of Engineering cards",
      "Pulse of Marketing and Rhythm of Operations cards",
      "Member-services and regulatory/compliance speaker tiles",
      "regulatory/compliance speaker tiles",
      "engineering/cable fiber topics",
      "Let's Get Started end card",
      "Co-op broadband teams, marketers, member-services leaders",
      "Event marketing, workshop launch, attendee communications",
    ],
    forbidden: [
      "Workshop knowledge captured with enough structure",
      "Serialized workshops",
      "Round table films",
      "Corporate",
      "Houston-led production",
  ...
  },
  {
    ...
    required: [
      ...
      "20-second 2772x524 jumbotron master",
      "30fps high-bitrate H.264 delivery",
      "First-responder photo mosaic",
      "Proud sponsor handwritten typography",
      "bp mark positioned for ultra-wide playback",
      "Ribbon-board caption space",
      "Lower West and Lower East sideline ribbons",
      "bp green and bp font corrections",
      "End-zone panel delivery",
      "VIB review path",
      "Final submission confirmation",
    ],
    forbidden: [
      "BP NRG Stadium Feature",
      "A first-responder grid built for NRG Stadium scale.",
      "Create a stadium-scale asset that reads instantly from across the room.",
      "59.94 progressive feedback",
      "frame-rate feedback for 59.94 progressive playback",
    ],
  },
  {
    ...
    required: [
      ...
      "Accurate logo open and close",
      "Green pipe inventory",
      "Warehouse shelves and boxed inventory",
      "Meter and valve hardware closeups",
      "Micah Burson",
      "Karl Eberhart",
      "SKE Construction testimonial",
      "Meter/vault technical animation",
      "Excavation and utility crew context",
      "Water-flow macro imagery",
      "full-service waterworks and utility-supply provider",
      "later Accurate Meter filming, training, headshot, and technical tutorial work",
      "2:17 1080p utility supply capability film",
    ],
    forbidden: [
      "Energy brand",
      "Accurate Meter Company Overview",
  ...
  },
  {
    ...
    required: [
      "Baylor University Black Glasses Film Festival Opener",
      "42.21-second 1280x720 festival opener",
      "23.976fps H.264/AAC delivery",
      "Annual Baylor Film & Digital Media showcase",
      "Student filmmaking and screenwriting context",
      "Festival originated in 1999",
      "Baylor Film & Digital Media context",
      "Yellow-and-black identity system",
      "Cinema title card",
      "Screenwriting title card",
      "Film and Digital Media Presents frame",
      "Welcome to Black Glasses title card",
      "3D shard-break animation",
      "Dimensional Black Glasses logo reveals",
  ...
  },
  {
    ...
    required: [
      "7 Minutes in Heaven Music Video",
      "7 Minutes in Heaven title confirmed by Rev transcript order",
      "3:28.68 1280x720 music video",
      "23.976fps H.264/AAC delivery",
      "Phone-call and party-floor opening texture",
      "White-background vocalist, guitar, and drum-kit setup",
      "Magenta club-light performance look",
      "Handheld crowd movement",
      "Crowd singalong and arms-in-the-air moments",
      "Smoke-backed drum-kit frames",
      "Bright backlight silhouettes",
      "Bailey Eubanks Media end mark",
      "Little Rock pop-rock band context",
    ],
    forbidden: [
  ...
  },
  {
    ...
    required: [
      ...
      "Before It's Too Late Awareness PSA",
      "Before It's Too Late PSA",
      "Tyler Type One warning-signs page context",
      "Survivors diagnosed hours from death public-page framing",
      "TelevisionOnline Spot title confirmed by Rev transcript order",
      "60.19-second 1280x720 awareness spot",
      "23.976fps H.264/AAC delivery",
      "TylerTypeOne.org end card",
      "Support...for life! CTA",
      "Football-field and school-bleacher texture",
      "Bike and outdoor childhood details",
      "Glucose meter closeup",
      "Insulin pump patch detail",
      "KwikPen closeup",
      "Local support system founded in 2009",
    ],
    forbidden: [
  ...
  },
  {
    ...
    required: [
      ...
      "3:00.28 1280x720 event film",
      "23.976fps H.264/AAC delivery",
      "InFocus 2025 Fit for Growth welcome signage",
      "Badge-table registration detail",
      "Blue-curtain keynote stage",
      "Lobby interview portraits",
      "Pitch & Putt with BenInsights signage",
      "Golf-club hospitality detail",
      "award-recognition plaques",
      "Branded ballroom keynote coverage",
      "Table-workshop note-taking",
      "Claritev-branded table-workshop materials",
      "Wide ballroom audience coverage",
      "2024 exceptional sales performance plaques",
      "Claritev end card",
    ],
    forbidden: [
      "Clartiv Sales Leadership Summit",
      "Clartiv's Sales Leadership Summit",
      "Summit coverage that outlasts the keynote.",
  ...
  },
  {
    ...
    forbidden: [
      "specialized builds, shop detail, and turnkey project confidence",
      "Product/process visuals",
  ...
  },
  {
    ...
    required: [
      ...
      "59.5-second 1080p paint-and-sip campaign cut",
      "Girls night out title graphics",
      "Have fun group-photo proof",
      "Tulsa and Somerville testimonial overlays",
      "Bold NO objection-handling graphic",
      "Reserved seating message",
      "Wine-glass cheers and phone-photo texture",
      "Brush-and-canvas closeups",
      "Paint & sip studios nationwide CTA",
      "Franchise studio campaign",
      "Private-party guests, studio owners, franchise marketers",
      "Website, social ads, studio booking pages",
    ],
    forbidden: ["Girls Night Out Campaign Film", "Campaign velocity", "Short-form polish", "Houston-led production", "59-second campaign film"],
  },
  {
    ...
    required: [
      ...
      "30.16-second, 1280x720 Pinot's Palette Black Light Night promo",
      "Neon Pinot's Palette logo open",
      "Face-paint application scene",
      "Glow-stick prep and balloon texture",
      "Apron-and-easel studio rows",
      "Black-light canvas reveal closeups",
      "Turn it up a notch title card",
      "Turn a regular night into something copy",
      "Snap the glowsticks copy",
      "2025 hi-res footage archive request",
      "First CTV commercial asset retrieval",
      "Canva photo-library reuse context",
    ],
    forbidden: ["Event promotion for paint-and-sip venue", "Event promo", "Social-ready", "Booking driver", "30-second 720p social/web spot"],
  },
  {
    ...
    required: [
      ...
      "Manufacturing capability film",
      "March 2022 video brief and tour",
      "March 3, 2023 company-overview shoot",
      "7777 Hollister facility aerials",
      "Founding and ribbon-cutting history",
      "New-era facility signage",
      "Samuel Gray leadership interview",
      "Ridge-vent, louver, canopy, trim, and flashing context",
      "Quote and order paperwork",
      "Safety-glasses and lunch-and-learn context",
