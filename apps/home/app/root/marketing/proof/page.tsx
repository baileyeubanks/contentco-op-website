...
function toneForStatus(value: string) {
  ...
  if (lowered.includes("approved") || lowered.includes("published") || lowered.includes("live") || lowered.includes("completed")) return "success" as const;
  if (lowered.includes("blocked") || lowered.includes("pending") || lowered.includes("review")) return "warn" as const;
  ...
  return (
    <div className="root-atlas-page" style={{ maxWidth: 1320 }}>
      <div style={{ display: "grid", gap: 22 }}>
        <ModuleHeader
          kicker={brand.key === "acs" ? "marketing + reputation engine" : "marketing + delivery engine"}
          title={brand.key === "acs" ? "reputation" : "proof"}
        ...
        <section style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
          <div style={card}>
            ...
            <a href={snapshot.primaryAction.href} target={snapshot.primaryAction.href.startsWith("/") ? undefined : "_blank"} rel={snapshot.primaryAction.href.startsWith("/") ? undefined : "noopener noreferrer"} style={{ ...rowStyle, textDecoration: "none", color: "inherit" }}>
              <div style={{ display: "grid", gap: 4 }}>
