...
- [types-system](types-system.md) — TypeScript types matching schema
- [firebase-integration](firebase-integration.md) — Firestore collections (parallel data)
- [api-routes](api-routes.md) — API layer over schema
