...
- [monorepo-structure](monorepo-structure.md) — Directory layout
- [types-system](types-system.md) — Type conventions
- [api-routes](api-routes.md) — API patterns in practice
