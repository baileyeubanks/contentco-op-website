...
- [contact-intelligence](contact-intelligence.md) — CRM details
- [quote-invoice-system](quote-invoice-system.md) — Commercial pipeline
- [dispatch-operations](dispatch-operations.md) — Work management
- [api-routes](api-routes.md) — All ROOT API endpoints
