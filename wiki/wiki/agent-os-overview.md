...
- [hermes-control-plane](hermes-control-plane.md) — Hermes details
- [paperclip-governance](paperclip-governance.md) — Paperclip architecture
- [codex-ide](codex-ide.md) — Development environment
- [deployment-infrastructure](deployment-infrastructure.md) — M2/M4/Cloudflare
- [ollama-inference](ollama-inference.md) — Local model setup
